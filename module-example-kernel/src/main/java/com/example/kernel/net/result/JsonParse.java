...
public class JsonParse {
    ...
    public static RequestBody createRequestBody(int pageNum, int pageSize, Map map) {
        JSONObject jsonObject = mapToJson(map);
    ...
    public static RequestBody createRequestBody(int pageNum, int pageSize, JSONObject json) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("recFrom", "andriod");
    ...
    public static RequestBody createImageRequestBody(File file) {

package com.example.widget.dialog.debug;
...
import com.example.cache.AccountManager;
...
//    private static final String SERVER_LIST = "serverList";
    ...
    public DebugBaseServerDialog(final Activity context) {
        ...
        layout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.dialog_debug_base_server, null);


        serverList = new ArrayList<>();
        serverList.addAll(AppConfig.DefaultServerUrlList);
        position = AccountManager.getInstance().getServerUrl(context);
        ...
        builder.setTitle("重启APP?")
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        AccountManager.getInstance().setServerUrl(context, position);
                        Intent mStartActivity = new Intent("android.intent.action.MAIN");
                        mStartActivity.setClassName("com.shangyizhijia.marke","com.shangyizhijia.marke.ui.activity.login.SplashNullActivity");
